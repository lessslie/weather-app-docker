...
export class WeatherController {
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene información meteorológica actual de una ciudad argentina específica',
  })
  @ApiQuery({
    name: 'city',
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene información meteorológica usando el nombre de ciudad como parámetro de ruta',
  })
  @ApiResponse({
    status: 200,
    description: 'Información del clima obtenida correctamente',
  ...
  @ApiOperation({
    ...
    description:
      'Retorna información meteorológica de ciudades argentinas destacadas',
  })
  @ApiResponse({
    status: 200,
  ...
  async getFeaturedCities(): Promise<WeatherResponseDto[]> {
    ...
    const weatherPromises = featuredCities.map((city) =>
      this.weatherService.getWeatherByCity({ city }).catch((error) => {
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene información meteorológica de varias ciudades argentinas en una sola petición',
  })
  @ApiResponse({
    status: 200,
